...
def NN(df, target_var):
    ...
    for train_idx, test_idx in outer_cv.split(x, y):
        ...
        model = Sequential()
        model.add(Dense(64, activation='relu', kernel_regularizer=l1(0.01), input_shape=(x_train.shape[1],)))
        model.add(Dense(32, activation='relu', kernel_regularizer=l1(0.01)))
        model.add(Dense(1, activation='sigmoid',kernel_regularizer=l1(0.01)))  # Binary Classification
